      ...
      <div class="container text-center text-md-start mt-5">
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p><a href="#!" class="text-reset">Thời trang</a></p>
            <p><a href="#!" class="text-reset">Các loại bánh</a></p>
          </div>
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p><a href="#!" class="text-reset">Website</a></p>
            <p><a href="#!" class="text-reset">Trợ Giúp</a></p>
          </div>
